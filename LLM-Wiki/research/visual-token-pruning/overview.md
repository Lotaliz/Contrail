...
12. MetaCompress 将剪枝与合并统一为学习式压缩矩阵，并证明多轮 VQA 中当前 prompt attention 可能比随机/均匀采样更差；但其目标是保留未知后续问题所需的一般视觉信息，不是安全语义或策略条件化剪枝。
...
- [[LLM-Wiki/concepts/methods/deepstack-visual-token-injection.md|概念：DeepStack 视觉 Token 深度注入]]
- [[LLM-Wiki/research/visual-token-pruning/papers/2025-bai-qwen3-vl.md|Qwen3-VL 多深度 DeepStack 聚焦笔记]]
- [[LLM-Wiki/research/visual-token-pruning/papers/2026-wang-metacompress.md|MetaCompress 多轮 VQA 学习式压缩精读]]
